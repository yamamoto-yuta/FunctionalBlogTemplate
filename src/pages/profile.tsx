...
const Profile: NextPage<Props> = ({ config, profile, skillTags }: { config: ConfigJson, profile: ProfileJson, skillTags: string[] }) => {
    return (
        <div >
            <Head>
            ...
            <main>
                <ProfilePage config={config} profile={profile} skillTags={skillTags} />
            </main>
            <footer>
